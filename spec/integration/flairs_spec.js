...
describe("routes : flairs", () => {
  ...
  describe("POST /topics/:topicId/flairs/create", () => {
    ...
    it("should create a new flair and redirect to topic main", (done) => {
      const options = {
      ...
      request.post(options, (err, res, body) => {
        Flair.findOne({where: {name: "Summer Sun"}})
        .then( (flair) => {
          expect(flair).not.toBeNull();
          expect(flair.name).toBe("Summer Sun");
  ...
  describe("POST /topics/:topicId/flairs/:id/update", () => {
    ...
    it("should update the flair with the given values", done => {
      ...
      request.post(options, (err, res, body) => {
        ...
        .then( flair => {
          expect(flair.name).toBe("Snowblind");
          done();
        });
      });
    });
