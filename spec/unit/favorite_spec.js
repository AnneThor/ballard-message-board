...
describe("Favorite", () => {
  ...
  beforeEach( done => {
    this.user; this.topic; this.post; this.favorite;
  ...
  describe("#create()", ()=> {
    ...
    it("should not create a favorite without assigned post or user", done => {
      ...
      .then( favorite => {
        //code won't run bc it will violate the sequlize requirement
        done();
      })
      .catch( err => {
  ...
  }); //closes describe create fav function
